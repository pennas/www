...
<html lang="en">
            ...
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item mytext_navlink" href="#">Εκτελωνισμοί</a>
                  <a class="dropdown-item mytext_navlink" href="#">Ασφαλίσεις</a>
                  <a class="dropdown-item mytext_navlink" href="#">Μεταφορές</a>
                  <!-- Dropdown Divider -->
                  <!--
              ...
              <li class="nav-item">
                <a class="nav-link mycolor_navlink mytext_navlink" href="#">Χρήσιμοι Σύνδεσμοι</a>
              </li>
              <li class="nav-item">
                <a class="nav-link mycolor_navlink mytext_navlink" href="#">Επικοινωνία</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#"><img src="img/Navbar/background.png" class="" href="#" alt="en"></a>
              </li>
  ...
  <body>
    ...
    <section id="slider">
      <img class="full-width_import" src="img/backgrounds/header-bg-two_13.jpg" alt="slider-image">
    </section>
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
              <?php
                  ...
                  $recipient = "asterpennas@gmail.com.com";
              ...
              ?>
                  ...
                  <h2 class="section-heading"> <?php echo "Ευχαριστούμε!"?> </h2>
                  <h3 class="section-subheading">Το μηνυμά σας στάλθηκε επιτυχώς. Σύντομα θα επικοινωνήσει μαζί σας ένας εκπρόσωπος της εταιρείας μας. </h3>
                <!--  <h2 class="section-heading">--> <?php //echo "Thank you!"?> <!--</h2>-->
                  ...
                  <a class="btn btn-xl animated bounceInUp service" alt="Αρχική" href="<?php echo SITELINK; ?>"><i class="fas fa-home fa-2x" alt="Αρχική"></i></a>
